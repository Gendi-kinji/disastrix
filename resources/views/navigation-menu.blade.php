    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @can('edit heads')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('heads') }}" :active="request()->routeIs('admins')" class="text-white">
                        {{ __('Organization heads') }}
                    </x-nav-link>
                </div>
                @endcan
                @can('edit statistics')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('calculate-statistics') }}" :active="request()->routeIs('admins')" class="text-white">
                        {{ __('Statistics') }}
                    </x-nav-link>
                </div>
                @endcan
